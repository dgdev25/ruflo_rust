...
/// Memory distillation — RETRIEVE→JUDGE→DISTILL→CONSOLIDATE pipeline.
/// Ports services/memory-distillation.ts behavioral parity: extracts patterns
/// from recorded episodes (keyword/frequency analysis), builds causal edges
/// between co-occurring patterns, and consolidates into structured intelligence.
